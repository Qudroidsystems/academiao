                        ...
                        <div class="admission-summary" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 40px; border-radius: 15px; text-align: center;">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="stat-item">
                                        <h4 style="font-size: 36px; margin: 0; font-weight: bold;">7</h4>
                                ...
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="stat-item">
                                        <h4 style="font-size: 36px; margin: 0; font-weight: bold;">5</h4>
                                        <p style="margin: 5px 0 0 0; opacity: 0.9;">Senior High</p>
                                    </div>
                                </div>
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="stat-item">
                                        <h4 style="font-size: 36px; margin: 0; font-weight: bold;">4</h4>
